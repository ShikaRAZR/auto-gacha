...
def auto_dailies_3():
    ...
    while exist_similar_img_searcharea_below("store-top-2.png", "store-diggcoin.png", 200) is not None:
        click_random_img_searcharea_below("store-top-2.png", "store-diggcoin.png", 200)
        wait(1)
