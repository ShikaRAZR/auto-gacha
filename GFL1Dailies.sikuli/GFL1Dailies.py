...
def click_random_img(img, similarity=0.8, repeat=1, rand_start=0.0, rand_end=0.0):
    wait(1) # wait 1 second for screen to load before detection
...
def do_combat_simulation():
    ...
    if data_mode == 1: 
        ...
        click_random_img("simulation-add.png", repeat=12, rand_start=0.1, rand_end=0.5)
    if data_mode == 2: 
        click_random_img("intermediate-training.png")
        click_random_img("simulation-add.png", repeat=6, rand_start=0.1, rand_end=0.5)
    if data_mode == 3: 
        click_random_img("advanced-training.png")
        click_random_img("simulation-add.png", repeat=4, rand_start=0.1, rand_end=0.5)
...
# click_random_img("research-add.png", repeat=1, rand_start=0.0, rand_end=0.0)
